const { PartnerInvoices } = require("./partnerInvoices.class");
const createModel = require("../../models/partnerInvoices.model");
const hooks = require("./partnerInvoices.hooks");
...
module.exports = function (app) {
  ...
  app.use("/partnerInvoices", new PartnerInvoices(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("partnerInvoices");

  // Get the schema of the collections 
  app.get("/partnerInvoicesSchema", function (request, response) {
