const { UsageLogs } = require("./usageLogs.class");
const createModel = require("../../models/usageLogs.model");
const hooks = require("./usageLogs.hooks");
...
module.exports = function (app) {
  ...
  app.use("/usageLogs", new UsageLogs(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("usageLogs");

  // Get the schema of the collections 
  app.get("/usageLogsSchema", function (request, response) {
