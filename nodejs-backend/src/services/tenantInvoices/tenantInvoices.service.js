const { TenantInvoices } = require("./tenantInvoices.class");
const createModel = require("../../models/tenantInvoices.model");
const hooks = require("./tenantInvoices.hooks");
...
module.exports = function (app) {
  ...
  app.use("/tenantInvoices", new TenantInvoices(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("tenantInvoices");

  // Get the schema of the collections 
  app.get("/tenantInvoicesSchema", function (request, response) {
