const { TenantServices } = require("./tenantServices.class");
const createModel = require("../../models/tenantServices.model");
const hooks = require("./tenantServices.hooks");
...
module.exports = function (app) {
  ...
  app.use("/tenantServices", new TenantServices(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("tenantServices");

  // Get the schema of the collections 
  app.get("/tenantServicesSchema", function (request, response) {
