...
import seederData from "./usageLogs.seeder.json";
...
const UsageLogsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UsageLogsSeederDialogComponent);
