...
const TenantsEditDialogComponent = (props) => {
...
isActive: _entity?.isActive,
        ...
        await client.service("tenants").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info tenants updated successfully" });
    ...
    return (
        <Dialog header="Edit Tenants" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="tenants-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(TenantsEditDialogComponent);
