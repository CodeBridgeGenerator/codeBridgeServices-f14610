...
const SingleTenantsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("tenants")
            .get(urlParams.singleTenantsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleTenantsId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>tenants/{urlParams.singleTenantsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">IsActive</label><p className="m-0" ><i id="isActive" className={`pi ${_entity?.isActive?"pi-check": "pi-times"}`}  ></i></p></div>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleTenantsId}
        user={props.user}
        alert={props.alert}
        serviceName="tenants"
      />
...
export default connect(mapState, mapDispatch)(SingleTenantsPage);
