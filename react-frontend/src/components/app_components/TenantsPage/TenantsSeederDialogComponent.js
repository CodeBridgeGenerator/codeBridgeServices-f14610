...
import seederData from "./tenants.seeder.json";
...
const TenantsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TenantsSeederDialogComponent);
