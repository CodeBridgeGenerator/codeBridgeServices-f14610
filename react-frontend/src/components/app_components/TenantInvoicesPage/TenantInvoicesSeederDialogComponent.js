...
import seederData from "./tenantInvoices.seeder.json";
...
const TenantInvoicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TenantInvoicesSeederDialogComponent);
