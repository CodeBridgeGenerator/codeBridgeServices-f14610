...
import seederData from "./partnerInvoices.seeder.json";
...
const PartnerInvoicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartnerInvoicesSeederDialogComponent);
