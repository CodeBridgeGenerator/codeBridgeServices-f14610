...
import seederData from "./tenantServices.seeder.json";
...
const TenantServicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TenantServicesSeederDialogComponent);
