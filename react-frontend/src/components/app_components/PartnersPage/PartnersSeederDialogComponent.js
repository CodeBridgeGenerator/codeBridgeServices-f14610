...
import seederData from "./partners.seeder.json";
...
const PartnersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartnersSeederDialogComponent);
