...
const SinglePartnersPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("partners")
            .get(urlParams.singlePartnersId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singlePartnersId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>partners/{urlParams.singlePartnersId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">IsActive</label><p className="m-0" ><i id="isActive" className={`pi ${_entity?.isActive?"pi-check": "pi-times"}`}  ></i></p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Tenants" leftIcon="pi pi-building-columns mr-2">
                        <TenantsPage/>
                    </TabPanel>
      ...
      <CommentsSection
        recordId={urlParams.singlePartnersId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SinglePartnersPage);
