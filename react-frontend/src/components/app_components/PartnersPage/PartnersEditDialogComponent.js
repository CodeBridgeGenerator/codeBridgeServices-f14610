...
const PartnersEditDialogComponent = (props) => {
...
isActive: _entity?.isActive,
        ...
        await client.service("partners").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info partners updated successfully" });
    ...
    return (
        <Dialog header="Edit Partners" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="partners-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(PartnersEditDialogComponent);
